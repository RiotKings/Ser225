...
public class Floor2BossFloor extends Map {
    private float scaleX = 1.0f;
    private float scaleY = 1.0f;

    public Floor2BossFloor() {
        super("Floor2BossFloor.txt", new Tileset2());
    ...
    public ArrayList<NPC> loadNPCs() {
        ...
        if (bossTile != null) {
            Floor2Boss boss = new Floor2Boss(1, bossTile.getLocation().x, bossTile.getLocation().y);
