...
public class Floor2Room23 extends Map {
    public Floor2Room23() {
        super("Floor2Room23", new Tileset2());
            this.playerStartPosition = new Point(325, 370);
             this.setEnemyCount(4); // Change to 4
    }
    ...
    protected ArrayList<NPC> loadNPCs() {
        ...
        MapTile enemyTile0 = getMapTile(5, 2);
        if (enemyTile0 != null) {
        ...
        MapTile bugTile1 = getMapTile(9, 3);
        if (bugTile1 != null) {
            npcs.add(new Bug(1, bugTile1.getLocation()));
        }

        MapTile bugTile2 = getMapTile(3, 5);
        if (bugTile2 != null) {
            npcs.add(new Bug(1, bugTile2.getLocation()));
        }

        MapTile zombieTile1 = getMapTile(11, 4);
        if (zombieTile1 != null) {
